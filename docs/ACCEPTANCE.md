...
| M2 | The public deployment completes the same full mission in the declared judging browser. | [Live Pages URL](https://b33fydan.github.io/agentville-build-week/) + `npm run test:public` | **PASS** — 122/122 browser assertions on 2026-07-17 |
...
All automated criteria pass: 26/26 Node tests, 122/122 local production-browser assertions, and 122/122 public-browser assertions. M2, A16, and the A17 irrigation clue are complete; M1 and M3 remain visibly incomplete until genuine human and video evidence exists.
